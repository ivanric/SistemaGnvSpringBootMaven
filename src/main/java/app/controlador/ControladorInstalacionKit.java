...
@RequestMapping({"/InstalacionKit/"})
@Controller
public class ControladorInstalacionKit {
	...
	public String modal_add(HttpServletRequest request,Model m){
		...
		return "instalacionKit/modal-adicionar1";
	}
	...
	public String modal_ver(HttpServletRequest request,Model m){
		...
		return "instalacionKit/modal-ver";
	}
}
