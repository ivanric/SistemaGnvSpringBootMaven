...
@RequestMapping({"/MarcaReductor/"})
@Controller
public class ControladorMarcaReductor{
	...
	public String modal_add(HttpServletRequest request,Model m){
		...
		return "marcaReductor/modal-adicionar";
	}
	...
	public String modal_mod(HttpServletRequest request,Model m){
		...
		return "marcaReductor/modal-modificar";
	}
