...
@RequestMapping({"/TipoMarcaVehiculo/"})
@Controller
public class ControladorTipoMarcaVehiculo{
	...
	public String gestion(HttpServletRequest request,Model m){
		...
		return "tipoMarcaVehiculo/gestion";
	}
	...
	public String modal_add(HttpServletRequest request,Model m){
		...
		return "tipoMarcaVehiculo/modal-adicionar";
	}
	...
	public String modal_mod(HttpServletRequest request,Model m){
		...
		return "tipoMarcaVehiculo/modal-modificar";
	}
