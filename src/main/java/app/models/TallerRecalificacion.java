...
public class TallerRecalificacion {
	...
	public TallerRecalificacion() {
	}

	public TallerRecalificacion(Integer idtall, String nombretall, String direccion, String fecha_registro, Integer estado,
